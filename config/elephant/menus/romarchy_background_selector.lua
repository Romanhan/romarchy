Name = "romarchyBackgroundSelector"
NamePretty = "Romarchy Background Selector"
Cache = false
...
function GetEntries()
  ...
  local dirs = {
    home .. "/.config/romarchy/current/theme/backgrounds",
  }
  if theme_name then
    table.insert(dirs, home .. "/.config/romarchy/backgrounds/" .. theme_name)
  end
